...
<body class="min-h-full flex items-center justify-center p-6 bg-slate-950">
    <div class="max-w-xl w-full bg-slate-900/60 border border-slate-800 rounded-2xl p-8 relative overflow-hidden shadow-2xl space-y-6 transition-all duration-300 hover:border-slate-700">
        <!-- Background accents -->
