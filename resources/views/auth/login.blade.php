            ...
            <form class="space-y-4 pt-2" method="POST" action="{{ route('login.store') }}">
                ...
                @if (session('status'))
                    <div class="rounded-lg bg-emerald-500/10 border border-emerald-500/20 p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-xs text-emerald-300 font-medium">{{ session('status') }}</p>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <a href="{{ route('password.request') }}" class="text-xs text-blue-500 hover:underline font-semibold">Forgot Password?</a>
                    </div>
                    <div class="relative">
