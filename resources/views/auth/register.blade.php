        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="{{ route('login.show') }}" class="font-medium text-blue-600 hover:text-blue-500">
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('register.store') }}">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name') }}" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm" placeholder="Full Name">
                    </div>
                    <div>
