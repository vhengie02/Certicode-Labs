        ...
        <form action="{{ route('classes.update', $class->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="passing_threshold" id="passing_threshold" min="1" max="100" value="{{ old('passing_threshold', $class->passing_threshold ?? 75) }}"
                        class="w-full px-3.5 py-2.5 bg-[#141414] border border-[#2e2e2e] rounded-[6px] text-sm text-[#ededed] placeholder-[#666666] focus:outline-none focus:border-[#3ecf8e] focus:ring-1 focus:ring-[#3ecf8e] transition-colors">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="scheduled_end_date" id="scheduled_end_date" 
                        value="{{ old('scheduled_end_date', $class->scheduled_end_date ? $class->scheduled_end_date->format('Y-m-d\TH:i') : '') }}"
