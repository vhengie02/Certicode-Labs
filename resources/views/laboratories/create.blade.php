...
@section('page_header', 'Create Coding Laboratory Exercise')
...
<div class="max-w-4xl mx-auto">
    <div class="rounded-xl p-8 bg-[#171717] border border-[#2e2e2e]">
        <div class="mb-6">
            ...
            <h2 class="text-lg font-bold text-[#ededed] mt-0.5">New Laboratory Specifications</h2>
        </div>
        ...
        <form action="{{ route('laboratories.store') }}" method="POST" class="space-y-6" x-data="{ tasks: [{ task: '', command: '' }] }">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" name="title" id="title" required value="{{ old('title') }}" placeholder="e.g. Lab 1.3: Loop Condition Bounds"
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <select name="module_id" id="module_id" required 
                        ...
                        @foreach($class->modules as $mod)
                            <option value="{{ $mod->id }}" {{ old('module_id') == $mod->id ? 'selected' : '' }} class="bg-[#141414] text-[#ededed]">{{ $mod->title }}</option>
                        @endforeach
                    </select>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" required placeholder="Describe what the student must implement, expected inputs, and outputs..."
